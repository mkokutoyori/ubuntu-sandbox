...
/**
 * `retransmit` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiRouterRadiusRetransmitCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'retransmit',
    summary: 'Set RADIUS retransmit count',
    usage: 'retransmit <n>',
    args: [
      { name: 'n', type: 'int', required: true, description: 'retransmit' },
    ],
    options: [],
    privileges: OP,
    category: 'router',
