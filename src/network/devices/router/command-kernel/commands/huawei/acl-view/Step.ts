...
/**
 * `step` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiRouterAclStepCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'step',
    summary: 'Set ACL rule step',
    usage: 'step <n>',
    args: [
      { name: 'step', type: 'int', required: true, description: 'step increment' },
    ],
    options: [],
    privileges: OP,
    category: 'router',
