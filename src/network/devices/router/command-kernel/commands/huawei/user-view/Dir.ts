...
/**
 * `dir` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiRouterUserDirCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'dir',
    summary: 'List flash contents',
    usage: 'dir [<path>]',
    args: [
      { name: 'rest', type: 'string', required: false, variadic: true, description: 'dir tokens' },
    ],
    options: [],
    privileges: ANY,
    category: 'router',
