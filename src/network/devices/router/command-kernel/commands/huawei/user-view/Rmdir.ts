...
/**
 * `rmdir` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiRouterUserRmdirCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'rmdir',
    summary: 'Remove a directory',
    usage: 'rmdir <dir>',
    args: [
      { name: 'dir', type: 'string', required: true, description: 'directory' },
    ],
    options: [],
    privileges: OP,
    category: 'router',
