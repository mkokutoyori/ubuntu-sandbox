 ...
 */
export class HuaweiRouterClockCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'clock',
    summary: 'Set the system clock manually',
    usage: 'clock datetime HH:MM:SS YYYY-MM-DD',
    args: [
      { name: 'rest', type: 'string', required: true, variadic: true, description: 'datetime tokens' },
    ],
    options: [],
    privileges: OP,
    category: 'router',
