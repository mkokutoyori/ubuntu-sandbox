 ...
 */
export class HuaweiRouterAaaRadiusServerCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'server',
    summary: 'Configure a RADIUS server (aaa-view)',
    usage: 'radius-server <subcommand...>',
    args: [
      { name: 'rest', type: 'string', required: true, variadic: true, description: 'radius tokens' },
    ],
    options: [],
    privileges: OP,
    category: 'router',
