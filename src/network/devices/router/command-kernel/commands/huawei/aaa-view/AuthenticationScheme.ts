...
/**
 * `authentication-scheme` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiRouterAaaAuthenticationSchemeCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'authentication-scheme',
    summary: 'Configure an authentication scheme',
    usage: 'authentication-scheme <name>',
    args: [
