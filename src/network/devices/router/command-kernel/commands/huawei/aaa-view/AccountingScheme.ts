...
/**
 * `accounting-scheme` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiRouterAaaAccountingSchemeCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'accounting-scheme',
    summary: 'Configure an accounting-scheme',
    usage: 'accounting-scheme <name>',
    args: [
