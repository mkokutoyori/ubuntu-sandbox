...
/**
 * `arp-broadcast` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiRouterIfArpBroadcastCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'arp-broadcast',
    summary: 'ARP broadcast configuration',
    usage: 'arp-broadcast {enable|disable}',
    args: [
