 ...
 */
export class HuaweiRouterIfOspfCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'ospf',
    summary: 'OSPF configuration on interface',
    usage: 'ospf {enable|cost|timer|authentication-mode|network-type} …',
    args: [
      { name: 'rest', type: 'string', required: true, variadic: true, description: 'ospf tokens' },
    ],
    options: [],
    privileges: OP,
    category: 'router',
