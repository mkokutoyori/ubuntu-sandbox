...
/**
 * `mac-address` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiRouterIfMacAddressCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'mac-address',
    summary: 'Set interface MAC address',
    usage: 'mac-address <H-H-H>',
    args: [
