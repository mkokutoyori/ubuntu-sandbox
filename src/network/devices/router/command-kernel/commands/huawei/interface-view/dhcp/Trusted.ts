...
/**
 * `trusted` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiRouterIfDhcpSnoopingTrustedCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'trusted',
    summary: 'Mark interface as DHCP snooping trusted',
    usage: 'dhcp snooping trusted',
    args: [],
    options: [],
    privileges: OP,
    category: 'router',
