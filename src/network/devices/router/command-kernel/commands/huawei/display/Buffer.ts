...
/**
 * `buffer` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiRouterDisplayBufferCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'buffer',
    summary: 'Display buffer usage',
    usage: 'display buffer',
    args: [],
    options: [],
    privileges: ANY,
    category: 'router',
