...
/**
 * `routing` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiRouterDisplayOspfRoutingCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'routing',
    summary: 'Display OSPF routing table',
    usage: 'display ospf routing',
    args: [],
    options: [],
    privileges: ANY,
    category: 'router',
