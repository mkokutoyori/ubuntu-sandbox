...
/**
 * `lsdb` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiRouterDisplayOspfLsdbCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'lsdb',
    summary: 'Display OSPF LSDB',
    usage: 'display ospf lsdb [<type>]',
    args: [
