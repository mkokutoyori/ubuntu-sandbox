...
/**
 * `session` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiRouterDisplayIpsecSessionCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'session',
    summary: 'Display IPSec sessions',
    usage: 'display ipsec session [<subcommand>]',
    args: [
