...
/**
 * `temperature` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiRouterDisplayTemperatureCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'temperature',
    summary: 'Display temperature sensors',
    usage: 'display temperature all',
    args: [
