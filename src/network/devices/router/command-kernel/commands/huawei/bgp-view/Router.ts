...
import { HuaweiRouterBgpRouterIdCommand } from './router/Id';
 ...
 */
export class HuaweiRouterBgpRouterCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'router',
    summary: 'BGP router-scope configuration',
  ...
  constructor() {
    super();
    this.subRegistry.register(() => new HuaweiRouterBgpRouterIdCommand());
  }
