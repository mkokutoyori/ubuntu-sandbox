 ...
 */
export class HuaweiRouterBgpNetworkCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'network',
    summary: 'Advertise a network in BGP',
    usage: 'network <A.B.C.D> [<mask|len>]',
    args: [
      { name: 'rest', type: 'string', required: true, variadic: true, description: 'network tokens' },
    ],
    options: [],
    privileges: OP,
    category: 'router',
