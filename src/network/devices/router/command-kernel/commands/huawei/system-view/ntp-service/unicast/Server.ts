 ...
 */
export class HuaweiRouterSysNtpServiceUnicastServerCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'server',
    summary: 'Configure an NTP unicast server',
    usage: 'ntp-service unicast-server <A.B.C.D>',
    args: [
      { name: 'server', type: 'string', required: true, description: 'NTP server IP' },
    ],
    options: [],
    privileges: OP,
    category: 'router',
