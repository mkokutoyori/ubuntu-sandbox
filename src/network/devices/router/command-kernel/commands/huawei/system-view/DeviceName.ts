...
/**
 * `device-name` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiRouterSysDeviceNameCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'device-name',
    summary: 'Device role/name (peer, master, slave …)',
    usage: 'device-name <name>',
    args: [
