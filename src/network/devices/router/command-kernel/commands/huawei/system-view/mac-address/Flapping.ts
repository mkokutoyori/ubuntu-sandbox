...
/**
 * `flapping` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiRouterSysMacAddressFlappingCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'flapping',
    summary: 'MAC address flapping configuration',
    usage: 'mac-address flapping <subcommand...>',
    args: [
