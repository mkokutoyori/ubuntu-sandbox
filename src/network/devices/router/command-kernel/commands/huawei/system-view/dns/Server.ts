 ...
 */
export class HuaweiRouterSysDnsServerCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'server',
    summary: 'Configure a DNS resolver server',
    usage: 'dns server <A.B.C.D>',
    args: [
      { name: 'ip', type: 'string', required: true, description: 'DNS server IP' },
    ],
    options: [],
    privileges: OP,
    category: 'router',
