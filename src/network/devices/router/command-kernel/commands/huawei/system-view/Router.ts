...
import { HuaweiRouterRouterIdCommand } from './router/Id';
 ...
 */
export class HuaweiRouterSysRouterCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'router',
    summary: 'Router-scope configuration',
  ...
  constructor() {
    super();
    this.subRegistry.register(() => new HuaweiRouterRouterIdCommand());
  }
