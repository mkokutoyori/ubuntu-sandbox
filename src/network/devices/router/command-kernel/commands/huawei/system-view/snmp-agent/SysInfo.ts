...
/**
 * `sys-info` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiRouterSnmpAgentSysInfoCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'sys-info',
    summary: 'Configure SNMP agent sys-info (contact/location)',
    usage: 'snmp-agent sys-info {contact|location|version} <value...>',
    args: [
