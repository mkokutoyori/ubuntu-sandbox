 ...
 */
export class CiscoRouterNtpServerCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'server',
    summary: 'Configure an NTP server',
    usage: 'ntp server <A.B.C.D>',
    args: [
      { name: 'ip', type: 'string', required: true, description: 'NTP server IP' },
    ],
    options: [],
    privileges: OP,
    category: 'router',
