...
/**
 * `synchronous` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class CiscoRouterConfigLineLoggingSynchronousCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'synchronous',
    summary: 'Synchronize unsolicited output',
