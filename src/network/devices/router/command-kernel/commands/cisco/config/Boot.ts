...
/**
 * `boot` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class CiscoRouterConfigBootCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'boot',
    summary: 'System boot params',
    usage: 'boot system <path>',
    args: [
      { name: 'rest', type: 'string', required: true, variadic: true, description: 'boot args' },
    ],
    options: [],
    privileges: OP,
    category: 'router',
