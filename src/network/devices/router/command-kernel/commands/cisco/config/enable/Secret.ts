...
/**
 * `secret` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class CiscoRouterConfigEnableSecretCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'secret',
    summary: 'Set privileged-EXEC password (encrypted)',
    usage: 'enable secret <text>',
    args: [
