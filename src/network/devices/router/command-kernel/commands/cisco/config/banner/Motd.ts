 ...
 */
export class CiscoRouterConfigBannerMotdCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'motd',
    summary: 'Message-of-the-day banner',
    usage: 'banner motd <text...>',
    args: [
      { name: 'text', type: 'string', required: true, variadic: true, description: 'MOTD text (delimiter tolérée)' },
    ],
    options: [],
    privileges: OP,
    category: 'router',
