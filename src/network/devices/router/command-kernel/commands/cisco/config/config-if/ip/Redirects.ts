...
/**
 * `redirects` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class CiscoRouterConfigIfIpRedirectsCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'redirects',
    summary: 'Enable ICMP redirects on interface',
    usage: 'ip redirects',
    args: [],
    options: [],
    privileges: OP,
