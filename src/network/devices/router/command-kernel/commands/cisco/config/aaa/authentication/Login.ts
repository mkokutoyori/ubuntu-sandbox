 ...
 */
export class CiscoRouterConfigAaaAuthenticationLoginCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'login',
    summary: 'AAA authentication for logins',
    usage: 'aaa authentication login <name> <method...>',
    args: [
      { name: 'rest', type: 'string', required: true, variadic: true, description: 'list-name + method(s)' },
    ],
    options: [],
    privileges: OP,
    category: 'router',
