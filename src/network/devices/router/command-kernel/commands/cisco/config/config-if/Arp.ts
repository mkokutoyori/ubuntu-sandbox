...
import { CiscoRouterConfigIfArpTimeoutCommand } from './arp/Timeout';
 ...
 */
export class CiscoRouterConfigIfArpCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'arp',
    summary: 'ARP configuration',
  ...
  constructor() {
    super();
    this.subRegistry.register(() => new CiscoRouterConfigIfArpTimeoutCommand());
  }
