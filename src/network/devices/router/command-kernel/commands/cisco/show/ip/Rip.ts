 ...
 */
export class CiscoRouterShowIpRipCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'rip',
    summary: 'Show IP RIP state',
    usage: 'show ip rip [database]',
    args: [
      { name: 'rest', type: 'string', required: false, variadic: true, description: 'sub-view (database)' },
    ],
    options: [],
    privileges: ANY,
    category: 'router',
