...
/**
 * `tech-support` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class CiscoRouterShowTechSupportCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'tech-support',
    summary: 'Show technical-support snapshot',
    usage: 'show tech-support',
    args: [],
    options: [],
    privileges: ANY,
    category: 'router',
