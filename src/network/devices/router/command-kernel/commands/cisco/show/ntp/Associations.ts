...
/**
 * `associations` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class CiscoRouterShowNtpAssociationsCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'associations',
    summary: 'NTP associations',
    usage: 'show ntp associations',
    args: [],
    options: [],
    privileges: ANY,
    category: 'router',
