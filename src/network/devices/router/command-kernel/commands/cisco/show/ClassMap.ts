...
/**
 * `class-map` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class CiscoRouterShowClassMapCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'class-map',
    summary: 'Show QoS class-map',
    usage: 'show class-map',
    args: [],
    options: [],
    privileges: ANY,
    category: 'router',
