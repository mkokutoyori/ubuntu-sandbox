...
/**
 * `policy-map` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class CiscoRouterShowPolicyMapCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'policy-map',
    summary: 'Show QoS policy-map',
    usage: 'show policy-map',
    args: [],
    options: [],
    privileges: ANY,
    category: 'router',
