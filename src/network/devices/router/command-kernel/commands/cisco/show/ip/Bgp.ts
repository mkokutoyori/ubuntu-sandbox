...
/**
 * `bgp` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class CiscoRouterShowIpBgpCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'bgp',
    summary: 'Show BGP info',
    usage: 'show ip bgp [summary|neighbors]',
    args: [
      { name: 'rest', type: 'string', required: false, variadic: true, description: 'BGP sub-view' },
    ],
    options: [],
    privileges: ANY,
    category: 'router',
