...
export function buildConfigCommands(trie: CommandTrie, ctx: CiscoShellContext): void {
  ...
  // MIGRATED (command-kernel): 'interface' — retrait trie legacy
...
//     });
  ...
  // MIGRATED (command-kernel): 'router rip' — retrait trie legacy
...
//     });
  ...
  // MIGRATED (command-kernel): 'ip address' — retrait trie legacy
...
//     });
  ...
  // MIGRATED (command-kernel): 'no ip address' — retrait trie legacy
...
//     });
  ...
  // MIGRATED (command-kernel): 'mtu' — retrait trie legacy
...
//       return '';
//     });
  // MIGRATED (command-kernel): 'delay' — retrait trie legacy
...
//     });
  ...
  // MIGRATED (command-kernel): 'duplex' — retrait trie legacy
...
//       return '';
//     });
  // MIGRATED (command-kernel): 'speed' — retrait trie legacy
...
//     });
  ...
  // MIGRATED (command-kernel): 'keepalive' — retrait trie legacy
...
//     });
  ...
  // MIGRATED (command-kernel): 'encapsulation' — retrait trie legacy
...
//     });
  ...
  // MIGRATED (command-kernel): 'no description' — retrait trie legacy
