...
/**
 * `dhcp-snooping` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiSwitchDisplayDhcpSnoopingCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'dhcp-snooping',
    summary: 'Display DHCP snooping configuration',
    usage: 'display dhcp snooping [<subcommand>]',
    args: [
