...
/**
 * `users` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiSwitchDisplayUsersCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'users',
    summary: 'Display active users/sessions',
    usage: 'display users [all]',
    args: [
