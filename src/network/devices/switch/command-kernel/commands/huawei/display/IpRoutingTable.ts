...
/**
 * `ip-routing-table` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiSwitchDisplayIpRoutingTableCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'ip-routing-table',
    summary: 'Display IP routing table (switch L3)',
    usage: 'display ip routing-table [protocol <p>]',
    args: [
