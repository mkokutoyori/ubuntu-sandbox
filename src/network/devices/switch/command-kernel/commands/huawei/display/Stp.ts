...
import { HuaweiSwitchDisplayStpBriefCommand } from './stp/Brief';
 ...
 */
export class HuaweiSwitchDisplayStpCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'stp',
    summary: 'Display STP information',
    usage: 'display stp [<subcommand>]',
    args: [],
    options: [],
    privileges: ANY,
    category: 'switch',
  ...
  constructor() {
    super();
    this.subRegistry.register(() => new HuaweiSwitchDisplayStpBriefCommand());
  }
