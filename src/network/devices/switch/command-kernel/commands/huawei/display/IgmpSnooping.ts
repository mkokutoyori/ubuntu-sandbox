 ...
 */
export class HuaweiSwitchDisplayIgmpSnoopingCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'igmp-snooping',
    summary: 'Display IGMP snooping configuration',
    usage: 'display igmp-snooping [<subcommand>]',
    args: [
