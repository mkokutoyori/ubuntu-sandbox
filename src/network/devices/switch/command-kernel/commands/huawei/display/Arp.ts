...
/**
 * `arp` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiSwitchDisplayArpCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'arp',
    summary: 'Display ARP table (switch)',
    usage: 'display arp [<A.B.C.D>]',
    args: [
