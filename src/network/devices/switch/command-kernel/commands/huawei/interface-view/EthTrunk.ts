 ...
 */
export class HuaweiSwitchIfEthTrunkCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'eth-trunk',
    summary: 'Bind the port to an Eth-Trunk (LAG)',
    usage: 'eth-trunk <group-id>',
    args: [
      { name: 'id', type: 'int', required: true, description: 'Eth-Trunk group id' },
    ],
    options: [],
    privileges: OP,
    category: 'switch',
