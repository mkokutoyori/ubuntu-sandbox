...
/**
 * `bpdu-filter` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiSwitchIfStpBpduFilterCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'bpdu-filter',
    summary: 'STP BPDU-filter on interface',
    usage: 'stp bpdu-filter {enable|disable}',
    args: [
