 ...
 */
export class HuaweiSwitchSysMacAddressStaticCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'static',
    summary: 'Static MAC entry',
    usage: 'mac-address static <mac> <iface> vlan <id>',
    args: [
      { name: 'rest', type: 'string', required: true, variadic: true, description: 'static mac tokens' },
    ],
    options: [],
    privileges: OP,
    category: 'switch',
