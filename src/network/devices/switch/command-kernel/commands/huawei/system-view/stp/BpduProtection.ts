...
/**
 * `bpdu-protection` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class HuaweiSwitchSysStpBpduProtectionCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'bpdu-protection',
    summary: 'Global STP BPDU protection',
    usage: 'stp bpdu-protection',
    args: [],
    options: [],
    privileges: OP,
    category: 'switch',
