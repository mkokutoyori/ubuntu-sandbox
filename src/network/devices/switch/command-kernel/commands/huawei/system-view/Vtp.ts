 ...
 */
export class HuaweiSwitchSysVtpCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'vtp',
    summary: 'VTP global configuration (VRP compat)',
    usage: 'vtp {mode|domain|password} …',
    args: [
      { name: 'rest', type: 'string', required: true, variadic: true, description: 'vtp tokens' },
    ],
    options: [],
    privileges: OP,
    category: 'switch',
