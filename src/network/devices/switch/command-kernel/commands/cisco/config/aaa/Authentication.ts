...
import { CiscoSwitchConfigAaaAuthenticationLoginCommand } from './authentication/Login';
 ...
 */
export class CiscoSwitchConfigAaaAuthenticationCommand extends BaseCommand {
  ...
  constructor() {
    super();
    this.subRegistry.register(() => new CiscoSwitchConfigAaaAuthenticationLoginCommand());
  }
