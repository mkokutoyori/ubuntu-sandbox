 ...
 */
export class CiscoSwitchConfigSnmpServerCommunityCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'community',
    summary: 'SNMP community',
    usage: 'snmp-server community <name> {RO|RW}',
    args: [
      { name: 'name', type: 'string', required: true, description: 'Community' },
