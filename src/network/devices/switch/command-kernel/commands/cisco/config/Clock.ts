 ...
 */
export class CiscoSwitchConfigClockCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'clock',
    summary: 'Global clock params',
    usage: 'clock timezone <name> <hours>',
    args: [
      { name: 'rest', type: 'string', required: true, variadic: true, description: 'timezone + offset' },
    ],
    options: [],
    privileges: OP,
    category: 'switch',
