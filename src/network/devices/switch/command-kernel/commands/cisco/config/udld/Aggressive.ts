...
/**
 * `aggressive` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class CiscoSwitchConfigUdldAggressiveCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'aggressive',
    summary: 'UDLD aggressive mode',
    usage: 'udld aggressive',
    args: [],
    options: [],
    privileges: OP,
    category: 'switch',
