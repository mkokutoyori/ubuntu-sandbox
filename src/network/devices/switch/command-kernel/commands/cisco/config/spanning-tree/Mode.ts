 ...
 */
export class CiscoSwitchGlobalSpanningTreeModeCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'mode',
    summary: 'Set spanning-tree operational mode',
    usage: 'spanning-tree mode {pvst|rapid-pvst|mst}',
    args: [
      { name: 'kind', type: 'string', required: true, description: 'pvst | rapid-pvst | mst' },
    ],
    options: [],
    privileges: OP,
    category: 'switch',
