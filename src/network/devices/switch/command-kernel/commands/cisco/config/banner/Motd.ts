...
/**
 * `motd` — TODO: une ligne d'intention métier.
 * Commande feuille standalone : `ctx.machine` est l'unique source de données, formatage inline.
 */
export class CiscoSwitchConfigBannerMotdCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'motd',
    summary: 'Message-of-the-day banner',
    usage: 'banner motd <text...>',
    args: [
      { name: 'text', type: 'string', required: true, variadic: true, description: 'MOTD text' },
    ],
    options: [],
    privileges: OP,
    category: 'switch',
