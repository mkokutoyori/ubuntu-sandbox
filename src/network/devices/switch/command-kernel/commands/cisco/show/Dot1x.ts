 ...
 */
export class CiscoSwitchShowDot1xCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'dot1x',
    summary: 'Show 802.1X state',
    usage: 'show dot1x [all]',
    args: [
      { name: 'rest', type: 'string', required: false, variadic: true, description: 'all|interface' },
    ],
    options: [],
    privileges: ANY,
    category: 'switch',
