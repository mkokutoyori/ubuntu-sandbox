 ...
 */
export class CiscoSwitchShowLldpCommand extends BaseCommand {
  readonly descriptor: CommandDescriptor = {
    name: 'lldp',
    summary: 'Show LLDP status / neighbors',
    usage: 'show lldp [neighbors]',
    args: [
      { name: 'rest', type: 'string', required: false, variadic: true, description: 'sub-view' },
    ],
    options: [],
    privileges: ANY,
    category: 'switch',
