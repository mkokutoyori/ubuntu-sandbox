...
const VIEWS: readonly GetView[] = Object.freeze([
  ...
  { words: ['vpn', 'ipsec', 'stats', 'tunnel'],
    help: 'How many tunnels and selectors, and how many are up.' },
