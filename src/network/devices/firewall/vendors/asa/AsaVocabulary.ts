...
export const ASA_VOCABULARY: Readonly<Record<AsaMode, readonly string[]>> = Object.freeze({
  ...
  config: Object.freeze([
    'aaa', 'access-group', 'access-list', 'crypto key generate', 'enable password',
    'end', 'exit', 'hostname', 'interface', 'logging',
    'object network', 'object-group network', 'passwd', 'same-security-traffic',
    'ssh', 'telnet', 'username',
  ]),
...
export const ASA_COMMAND_HELP: Readonly<Record<string, string>> = Object.freeze({
  ...
  'crypto key generate': 'Generate the RSA key pair used by the SSH server',
  'enable password': 'Set the privileged EXEC password',
  passwd: 'Set the Telnet login password',
  ssh: 'Permit SSH from a network on an interface, or set its options',
  telnet: 'Permit Telnet from a network on an interface, or set its timeout',
  username: 'Create a local user account',
