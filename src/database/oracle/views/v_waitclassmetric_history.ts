/**
 * V$WAITCLASSMETRIC_HISTORY — last-hour history of V$WAITCLASSMETRIC.
 */
...
registerView({
  name: 'V$WAITCLASSMETRIC_HISTORY',
  comment: 'Per-wait-class metric history',
  query(ctx) {
