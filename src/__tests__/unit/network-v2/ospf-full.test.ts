...
// The tests were written using abstract names; wrapper factories match the test signatures
function Router(_type: string, name: string) { return new CiscoRouter(name); }
function Switch(_type: string, name: string) { return new CiscoSwitch('switch-cisco', name, 24); }
