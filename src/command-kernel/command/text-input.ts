...
/**
 * Lecture texte commune à toute commande de traitement de flux, quel que
 * soit le vendeur : stdin si aucun fichier, sinon chaque fichier via
 * MachineApi — en préservant l'absence éventuelle de saut de ligne final.
 */
